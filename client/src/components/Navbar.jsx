...
const Navbar = () => {
  ...
  <span className="hidden sm:inline md:w-55 md:h-10 sm:w-44 sm:h-8 text-2xl font-semibold">CoHabit</span>
  <span className="inline sm:hidden h-7/8 text-lg font-semibold">CoHabit</span>
</Link>
